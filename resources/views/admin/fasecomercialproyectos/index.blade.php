...
@can('fasecomercialproyecto_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.fasecomercialproyectos.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Fasecomercialproyecto">
            <thead>
                <tr>
                    <th width="10">
...
@can('fasecomercialproyecto_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fasecomercialproyectos.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fasecomercialproyectos.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'nota_venta', name: 'nota_venta', sortable: false, searchable: false },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Fasecomercialproyecto').DataTable(dtOverrideGlobals);
