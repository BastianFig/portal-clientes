    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.proyectos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('categoria_proyecto') ? 'is-invalid' : '' }}" name="categoria_proyecto" id="categoria_proyecto">
                    ...
                    @foreach(App\Models\Proyecto::CATEGORIA_PROYECTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('categoria_proyecto', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_proyecto') ? 'is-invalid' : '' }}" name="tipo_proyecto" id="tipo_proyecto">
                    ...
                    @foreach(App\Models\Proyecto::TIPO_PROYECTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_proyecto', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_proyecto') ? 'is-invalid' : '' }}" type="text" name="nombre_proyecto" id="nombre_proyecto" value="{{ old('nombre_proyecto', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('disenador') ? 'is-invalid' : '' }}" name="disenador" id="disenador">
                    ...
                    @foreach(App\Models\Proyecto::DISENADOR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('disenador', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
