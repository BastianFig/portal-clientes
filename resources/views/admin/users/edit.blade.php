        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('sucursals') ? 'is-invalid' : '' }}"
                        name="sucursals[]" id="sucursals" multiple>
                        @foreach($sucursals as $id => $nombre)
                            <option value="{{ $id }}" {{ $user->sucursals->contains('id', $id) ? 'selected' : '' }}>
                                {{ $nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text"
                        name="telefono" id="telefono" value="{{ old('telefono', $user->telefono) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('foto_perfil') ? 'is-invalid' : '' }}"
                        id="foto_perfil-dropzone">
                    </div>
