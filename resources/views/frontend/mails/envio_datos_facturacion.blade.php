...
<html lang="es">
    <head>
        ...
        <title>Se han completado los Datos de Facturación.</title>
    </head>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:20px;text-align:center !important;">Comunicamos que se han completado los Datos de Facturación del Proyecto: <strong>({{$nombre_proyecto}})</strong>, Déjamos el detalle a continuación.<br>
                                                                                            </p> 
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:24px">
                                                                                                <ul>
                                                                                                    <li style="font-size: 24px;"><strong>Razón Social: </strong>{{$razon_social}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>RUT: </strong>{{$rut}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Giro: </strong>{{$giro}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Dirección: </strong>{{$direccion}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Email: </strong>{{$email}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Nombre de Contacto: </strong>{{$nombre_contacto}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Dirección de Despacho: </strong>{{$direccion_despacho}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Nombre de quien recibe: </strong>{{$nombre_despacho}} </li>
                                                                                                    <li style="font-size: 24px;"><strong>Teléfono de Contacto: </strong>{{$telefono_despacho}} </li>                                                                                      
                                                                                                </ul>
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
