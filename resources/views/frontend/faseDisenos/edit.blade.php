        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.fase-disenos.update', [$faseDiseno->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    ...
                                    value="{{ old('descripcion', $faseDiseno->descripcion) }}">
                            ...
                            <div class="form-group input-custom p-4"
                                ...
                                <div class="needsclick dropzone" id="propuesta-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    style="border: none; background-color: #f8f8f8; border-radius: 10px;" type="text"
                                    name="estado" id="estado" value="{{ old('estado', $faseDiseno->estado) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_proyecto_id" id="id_proyecto_id">
                                    @foreach ($id_proyectos as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('id_proyecto_id') ? old('id_proyecto_id') : $faseDiseno->id_proyecto->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
...
@section('scripts')
    <script>
        ...
        Dropzone.options.imagenesDropzone = {
            url: '{{ route('frontend.fase-disenos.storeMedia') }}',
            maxFilesize: 4, // MB
            addRemoveLinks: true,
            headers: {
