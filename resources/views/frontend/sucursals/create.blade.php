        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.sucursals.store') }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="direccion_sucursal">Dirección de la sucursal</label>
                                <input class="form-control input-custom"
                                    style="border: none; background-color: #f8f8f8; border-radius: 10px;"
                                    placeholder="Dirección de la sucursal" type="text" name="direccion_sucursal"
                                    id="direccion_sucursal" value="{{ old('direccion_sucursal', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="comuna" id="comuna">
                                    ...
                                    @foreach (App\Models\Sucursal::COMUNA_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('comuna', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
