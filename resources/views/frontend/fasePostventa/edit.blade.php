        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.fase-postventa.update', [$fasePostventum->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="encuesta_id" id="encuesta_id">
                                    @foreach ($encuestas as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('encuesta_id') ? old('encuesta_id') : $fasePostventum->encuesta->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="ticket_id" id="ticket_id">
                                    @foreach ($tickets as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('ticket_id') ? old('ticket_id') : $fasePostventum->ticket->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_proyecto_id" id="id_proyecto_id">
                                    @foreach ($id_proyectos as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('id_proyecto_id') ? old('id_proyecto_id') : $fasePostventum->id_proyecto->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_usuarios[]" id="id_usuarios" multiple>
                                    @foreach ($id_usuarios as $id => $id_usuario)
                                        <option value="{{ $id }}"
                                            {{ in_array($id, old('id_usuarios', [])) || $fasePostventum->id_usuarios->contains($id) ? 'selected' : '' }}>
                                            {{ $id_usuario }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    ...
                                    value="{{ old('estado', $fasePostventum->estado) }}">
