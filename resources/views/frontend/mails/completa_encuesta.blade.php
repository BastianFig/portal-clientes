...
<html lang="es">
    <head>
        ...
        <title>Se ha completado la Encuesta de su Proyecto {{ $nombre_proyecto }}.</title>
    </head>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:20px;text-align:center !important;">Estimado {{ $name }}, <br> Comunicamos que se ha completado la Encuesta de su Proyecto ({{$nombre_proyecto}}).<br>
                                                                                                </p> 
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:24px">
                                                                                                <ul>
                                                                                                    <li style="font-size: 24px;"><strong>Link de Encuesta: </strong> <a href="{{ url('admin/encuesta/') . '/' .$encuestaId }}">Ver Encuesta </a></li>
                                                                                                    <li style="font-size: 24px;"><strong>Fecha de Encuesta: </strong> {{now()}}</li>                                                                                                 
                                                                                                </ul>
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
