        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.fasedespachos.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date input-custom"
                                    ...
                                    name="fecha_despacho" id="fecha_despacho" value="{{ old('fecha_despacho') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="estado_instalacion" id="estado_instalacion">
                                    ...
                                    @foreach (App\Models\Fasedespacho::ESTADO_INSTALACION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('estado_instalacion', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor input-custom"
                                    style="border: none; background-color: #f8f8f8; border-radius: 10px;" name="comentario" id="comentario">{!! old('comentario') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="recibe_conforme" id="recibe_conforme">
                                    ...
                                    @foreach (App\Models\Fasedespacho::RECIBE_CONFORME_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('recibe_conforme', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
