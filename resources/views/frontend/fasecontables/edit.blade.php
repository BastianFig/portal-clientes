        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.fasecontables.update', [$fasecontable->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    ...
                                    value="{{ old('comentario', $fasecontable->comentario) }}" placeholder="Comentario">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_proyecto_id" id="id_proyecto_id">
                                    @foreach ($id_proyectos as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('id_proyecto_id') ? old('id_proyecto_id') : $fasecontable->id_proyecto->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    style="border: none; background-color: #f8f8f8; border-radius: 10px;" type="text"
                                    name="estado" id="estado" value="{{ old('estado', $fasecontable->estado) }}"
                                    placeholder="Estado">
