...
<html lang="es">
    <head>
        ...
        <title>Se ha generado una Solicitud en su Proyecto {{ $nombre_proyecto }}.</title>
    </head>
                                                                                    ...
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                            @if($tipo_usuario == "Vendedor")
                                                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:20px;text-align:center !important;">Estimado {{ $name_vendedor }}, <br> Comunicamos que se ha generado una Solicitud en su Proyecto ({{$nombre_proyecto}}).<br>
                                                                                                </p>                                                                                                                                                                                     
                                                                                            @else
                                                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:20px;text-align:center !important;">Estimado {{ $name_cliente }}, <br> Comunicamos que se ha respondido una Solicitud en su Proyecto ({{$nombre_proyecto}}).<br>
                                                                                                </p>
                                                                                            @endif
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#000000;font-size:24px">
                                                                                                <ul>
                                                                                                    @if($tipo_usuario == "Vendedor")
                                                                                                        <li style="font-size: 24px;"><strong>Cliente: </strong> {{$name_cliente}}</li>
                                                                                                        <li style="font-size: 24px;"><strong>Fecha de Solicitud: </strong> {{now()}}</li>
                                                                                                    @else
                                                                                                        <li style="font-size: 24px;"><strong>Vendedor: </strong> {{$name_vendedor}}</li>
                                                                                                        <li style="font-size: 24px;"><strong>Fecha de Solicitud: </strong> {{now()}}</li>
                                                                                                    @endif
                                                                                                </ul>
                                                                                            </p>
