        ...
        <div class="card-body">
            <form method="POST" action="{{ route('frontend.encuesta.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group pt-2 pb-2">
                    ...
                    <input class="form-control {{ $errors->has('nombre_encuestado') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-group pt-2 pb-2">
                    ...
                    <input class="form-control {{ $errors->has('mejorar_servicio') ? 'is-invalid' : '' }} input-custom"
                        type="text" name="mejorar_servicio" id="mejorar_servicio"
                ...
                <div class="form-group pt-2 pb-2">
                    ...
                    <input class="form-control {{ $errors->has('observacion') ? 'is-invalid' : '' }} input-custom"
                        type="text" name="observacion" id="observacion" value="{{ old('observacion', '') }}"
