...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-sucursalUsers">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                @foreach($user->sucursals as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-sucursalUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
