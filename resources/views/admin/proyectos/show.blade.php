    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <div class="form-group mb-5">
                <button class="btn btn-success text-white float-right" id="btn_ver_carpeta" data-toggle="modal"
                    data-target="#myModal2">Ver Carpeta Cliente</button>
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <ul class="c-process">
            ...
            <li class="c-process__item active" id="fase_1">1<div class="div_pasos1">Diseño</div>
            </li>
            <li class="c-process__item" id="fase_2">2<div class="div_pasos2">Propuesta Comercial</div>
            </li>
            <li class="c-process__item" id="fase_3">3<div class="div_pasos3">Contable</div>
            </li>
            <li class="c-process__item" id="fase_4">4<div class="div_pasos4">Acuerdo Comercial</div>
            </li>
            <li class="c-process__item" id="fase_5">5<div class="div_pasos5">Fabricación</div>
            </li>
            <li class="c-process__item" id="fase_6">6<div class="div_pasos6">Despachos</div>
            </li>
            <li class="c-process__item" id="fase_7">7<div class="div_pasos7">Postventa </div>
            </li>
            ...
            <div class="mx-5">
                <div class="carousel-inner">
                    <div class="carousel-item my-5 active" id="slide_fase_1">
                        ...
                        <form method="POST" action="{{route("admin.proyectos.storeFasediseno")}}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasediseno" id="id_fasediseno"
                                value="{{$proyecto->id_fasediseno}}">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('descripcion', $proyecto->fasediseno->descripcion ?? '') }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.faseDiseno.fields.descripcion_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="imagenes">{{ trans('cruds.faseDiseno.fields.imagenes') }} (Plano, fftt,
                                    Presentación, Renders)<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos: .JPG .PNG
                                            .DWG .XLSX .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('imagenes') ? 'is-invalid' : '' }}"
                                    id="imagenes-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                <label for="propuesta">Documentos de Apoyo (Imágenes inspiradoras)<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('propuesta') ? 'is-invalid' : '' }}"
                                    id="propuesta-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('estado', $proyecto->fasediseno->estado ?? '') }}">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="carousel-item my-5" id="slide_fase_2">
                        ...
                        <form method="POST" action="{{ route("admin.proyectos.storeFasecomercial") }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasecomercial" id="id_fasecomercial"
                                value="{{$proyecto->id_fasecomercial}}">
                            <div class="form-group">
                                <label for="comentarios">{{ trans('cruds.fasecomercial.fields.comentarios') }}</label>
                                <input class="form-control {{ $errors->has('comentarios') ? 'is-invalid' : '' }}"
                                    type="text" name="comentarios" id="comentarios"
                                    value="{{ old('comentarios', $proyecto->fasecomercial->comentarios ?? '') }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasecomercial.fields.comentarios_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="cotizacion">{{ trans('cruds.fasecomercial.fields.cotizacion') }}<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos: .PDF
                                            .XLSX)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('cotizacion') ? 'is-invalid' : '' }}"
                                    id="cotizacion-dropzone">
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasecomercial.fields.cotizacion_helper') }}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="oc">Orden de Compra <br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('oc') ? 'is-invalid' : '' }}"
                                    id="oc-dropzone">
                                </div>
                                @if($errors->has('oc'))
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}"
                                    type="hidden" name="estado" id="estado"
                                    value="{{ old('estado', $proyecto->fasecomercial->estado ?? '') }}">
                            </div>
                            <div class="form-group">
                                <button class="btn btn-danger" type="submit">
                                    {{ trans('global.save') }}
                    ...
                    <div class="carousel-item my-5" id="slide_fase_3">
                        ...
                        <form method="POST" action="{{ route("admin.proyectos.storeFasecontable") }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasecontables" id="id_fasecontables"
                                value="{{$proyecto->id_fasecontables}}">

                            @if($proyecto->id_cliente->antiguedad_empresa == 'Nuevo')
                                <div class="form-group">
                                    <label for="anticipo_50">{{ trans('cruds.fasecontable.fields.anticipo_50') }} (Subir
                                        Comprobante de Transferencia)<br><small
                                            style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                                .PDF)</strong></small></label>
                                    <div class="needsclick dropzone {{ $errors->has('anticipo_50') ? 'is-invalid' : '' }}"
                                        id="anticipo_50-dropzone">
                                    ...
                                    @endif
                                    <span
                                        class="help-block">{{ trans('cruds.fasecontable.fields.anticipo_50_helper') }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="anticipo_40">{{ trans('cruds.fasecontable.fields.anticipo_40') }} (Subir
                                        Comprobante de Transferencia)<br><small
                                            style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                                .PDF)</strong></small></label>
                                    <div class="needsclick dropzone {{ $errors->has('anticipo_40') ? 'is-invalid' : '' }}"
                                        id="anticipo_40-dropzone">
                                    </div>
                                    ...
                                    @endif
                                    <span
                                        class="help-block">{{ trans('cruds.fasecontable.fields.anticipo_40_helper') }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="anticipo_10">{{ trans('cruds.fasecontable.fields.anticipo_10') }} (Subir
                                        Comprobante de Transferencia)<br><small
                                            style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                                .PDF)</strong></small></label>
                                    <div class="needsclick dropzone {{ $errors->has('anticipo_10') ? 'is-invalid' : '' }}"
                                        id="anticipo_10-dropzone">
                                    </div>
                                    ...
                                    @endif
                                    <span
                                        class="help-block">{{ trans('cruds.fasecontable.fields.anticipo_10_helper') }}</span>
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-danger" type="submit">
                                        {{ trans('global.save') }}
                            ...
                            @if($proyecto->id_cliente->antiguedad_empresa == 'Confiable')
                                ...
                                <div class="form-group">
                                    <label for="anticipo_40">Pago 50% (Subir Comprobante de Transferencia)<br><small
                                            style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                                .PDF)</strong></small></label>
                                    <div class="needsclick dropzone {{ $errors->has('anticipo_40') ? 'is-invalid' : '' }}"
                                        id="anticipo_40-dropzone">
                            ...
                            @if($proyecto->id_cliente->antiguedad_empresa == 'Especial')
                                <div class="form-group">
                                    <label for="anticipo_50">Pagos (Subir Comprobante de Transferencia)<br><small
                                            style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                                .PDF)</strong></small></label>
                                    <div class="needsclick dropzone {{ $errors->has('anticipo_50') ? 'is-invalid' : '' }}"
                                        id="anticipo_50-dropzone">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route("admin.proyectos.storeCarpetacliente") }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="id_proyecto_id" id="id_proyecto_id"
                                            value="{{$proyecto->id}}">
                                        <input type="hidden" name="id_carpetacliente" id="id_carpetacliente"
                                            value="{{$proyecto->id_carpetacliente}}">
                                        <div class="form-group">
                                            <label
                                                for="presupuesto">{{ trans('cruds.carpetacliente.fields.presupuesto') }}</label>
                                            <div class="needsclick dropzone {{ $errors->has('presupuesto') ? 'is-invalid' : '' }}"
                                                id="presupuesto-dropzone">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="needsclick dropzone {{ $errors->has('plano') ? 'is-invalid' : '' }}"
                                                id="plano-dropzone">
                                            </div>
                                            @if($errors->has('plano'))
                                                <div class="invalid-feedback">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.carpetacliente.fields.plano_helper') }}</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="fftt">{{ trans('cruds.carpetacliente.fields.fftt') }}</label>
                                            <div class="needsclick dropzone {{ $errors->has('fftt') ? 'is-invalid' : '' }}"
                                                id="fftt-dropzone">
                                            </div>
                                            @if($errors->has('fftt'))
                                                <div class="invalid-feedback">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.carpetacliente.fields.fftt_helper') }}</span>
                                        </div>
                                        <div class="form-group">
                                            <label
                                                for="presentacion">{{ trans('cruds.carpetacliente.fields.presentacion') }}</label>
                                            <div class="needsclick dropzone {{ $errors->has('presentacion') ? 'is-invalid' : '' }}"
                                                id="presentacion-dropzone">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="rectificacion">{{ trans('cruds.carpetacliente.fields.rectificacion') }}</label>
                                            <div class="needsclick dropzone {{ $errors->has('rectificacion') ? 'is-invalid' : '' }}"
                                                id="rectificacion-dropzone">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="needsclick dropzone {{ $errors->has('nb') ? 'is-invalid' : '' }}"
                                                id="nb-dropzone">
                                            </div>
                                            @if($errors->has('nb'))
                                                <div class="invalid-feedback">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.carpetacliente.fields.nb_helper') }}</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="course">Curse</label>
                                            <div class="needsclick dropzone {{ $errors->has('course') ? 'is-invalid' : '' }}"
                                                id="course-dropzone">
                                            </div>
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.carpetacliente.fields.course_helper') }}</span>
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($proyecto) && !empty($proyecto->carpetacliente) && !empty($proyecto->carpetacliente->presupuesto))
                                                        <a href="{{ $proyecto->carpetacliente->presupuesto->getUrl() }}"
                                                            target="_blank">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($proyecto) && !empty($proyecto->carpetacliente) && !empty($proyecto->carpetacliente->rectificacion))
                                                        <a href="{{ $proyecto->carpetacliente->rectificacion->getUrl() }}"
                                                            target="_blank">
                                                            {{ trans('global.view_file') }}
                                                        </a>
                                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($proyecto) && !empty($proyecto->carpetacliente) && !empty($proyecto->carpetacliente->nb))
                                                        <a href="{{ $proyecto->carpetacliente->nb->getUrl() }}"
                                                            target="_blank">
                                                            {{ trans('global.view_file') }}
                                                        </a>
                                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($proyecto) && !empty($proyecto->carpetacliente) && !empty($proyecto->carpetacliente->course))
                                                        <a href="{{ $proyecto->carpetacliente->course->getUrl() }}"
                                                            target="_blank">
                                                            {{ trans('global.view_file') }}
                                                        </a>
                                                    @endif
                    ...
                    <div class="carousel-item my-5" id="slide_fase_4">
                        ...
                        <div class="form-group mb-5">
                            <button class="btn btn-warning text-white float-right" id="btn_cargar_carpeta"
                                data-toggle="modal" data-target="#myModal">Cargar Carpeta Cliente</button>
                        </div>
                        <form method="POST" action="{{ route("admin.proyectos.storeFasecomercialproyecto") }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasecomercialproyectos" id="id_fasecomercialproyectos"
                                value="{{$proyecto->id_fasecomercialproyectos}}">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select class="form-control {{ $errors->has('tipo_proyecto') ? 'is-invalid' : '' }}"
                                    ...
                                    <option value="{{ $key }}" {{ old('tipo_proyecto', $proyecto->
                                        faseComercialproyecto->tipo_proyecto ?? '') === (string) $key ? 'selected' : ''
                                        }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label for="facturas">Facturas<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('facturas') ? 'is-invalid' : '' }}"
                            ...
                            <div class="form-group">
                                <label for="credito">Nota de Crédito/Débito<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('credito') ? 'is-invalid' : '' }}"
                                    id="credito-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('fecha_despacho') ? 'is-invalid' : '' }}"
                                    type="date" name="fecha_despacho" id="fecha_despacho"
                                    value="{{ old('fecha_entrega', $proyecto->faseComercialproyecto->fecha_despacho ?? '') }}">
                            ...
                            <div class="form-group" id="div-monto-mobiliario">
                                @if($proyecto->faseComercialproyecto)
                                    ...
                                    <input type="text" id="monto_mobiliario" name="monto_mobiliario" class="form-control"
                                        value="{{ old('monto_mobiliario', $proyecto->faseComercialproyecto->monto_mobiliario ?? '') }}">
                                @else
                                    <label for="monto_mobiliario">Monto neto mobiliario</label>
                                    <input type="text" id="monto_mobiliario" name="monto_mobiliario" class="form-control">
                                @endif
                    ...
                    <div class="carousel-item my-5" id="slide_fase_5">
                        ...
                        <form method="POST" action="{{ route("admin.proyectos.storeFasefabricacion") }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control {{ $errors->has('aprobacion_course') ? 'is-invalid' : '' }}"
                                    name="aprobacion_course" id="aprobacion_course">
                            ...
                            <div class="form-group">
                                <label for="oc_proveedores">Orden de Compra Proveedores<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('oc_proveedores') ? 'is-invalid' : '' }}"
                                    id="oc_proveedores-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control {{ $errors->has('estado_produccion') ? 'is-invalid' : '' }}"
                                    name="estado_produccion" id="estado_produccion">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input class="form-control date {{ $errors->has('fecha_entrega') ? 'is-invalid' : '' }}"
                                    type="text" name="fecha_entrega" id="fecha_entrega"
                                    value="{{ old('fecha_entrega',  $proyecto->fasefabrica->fecha_entrega ?? '') }}">
                                @if($errors->has('fecha_entrega'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fecha_entrega') }}
                                </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.fasefabrica.fields.fecha_entrega_helper')
                                    }}</span>
                            </div> --}}
                            <div class="form-group">
                                <label
                                    for="galeria_estado_entrega">{{ trans('cruds.fasefabrica.fields.galeria_estado_entrega') }}<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos: .JPG .PNG
                                            .DWG .XLSX)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('galeria_estado_entrega') ? 'is-invalid' : '' }}"
                                    id="galeria_estado_entrega-dropzone">
                                </div>
                            ...
                            <div class="form-group">
                                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}"
                                    type="hidden" name="estado" id="estado"
                                    value="{{ old('estado', $proyecto->fasefabrica->estado ?? '') }}">
                            </div>
                            <div class="form-group">
                                <button class="btn btn-danger" type="submit">
                                    {{ trans('global.save') }}
                    ...
                    <div class="carousel-item my-5" id="slide_fase_6">
                        ...
                        <form method="POST" id="form-despachos"
                            action="{{ route("admin.proyectos.storeFasedespachos") }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasedespachos" id="id_fasedespachos"
                                value="{{$proyecto->id_fasedespachos}}">
                            <div class="form-group">
                                <h4>DATOS DE DESPACHO</h4>
                                <div class="form-group">
                                    <label for="total_parcial">Tipo de Despacho</label>
                                    <select class="form-control {{ $errors->has('total_parcial') ? 'is-invalid' : '' }}"
                                        name="total_parcial" id="total_parcial">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('lotes') ? 'is-invalid' : '' }}"
                                        type="number" name="lotes" id="lotes"
                                        value="{{ old('lotes', $proyecto->fasedespacho->lotes ?? '') }}">
                                    @if($errors->has('lotes'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('lotes') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <label
                                        for="fecha_despacho">{{ trans('cruds.fasedespacho.fields.fecha_despacho') }}</label>
                                    <input
                                        class="form-control  {{ $errors->has('fecha_despacho') ? 'is-invalid' : '' }}"
                                        type="date" name="fecha_despacho" id="fecha_despacho"
                                        value="{{ old('fecha_despacho', $proyecto->fasedespacho->fecha_despacho ?? '') }}">
                                    @if($errors->has('fecha_despacho'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('fecha_despacho') }}
                                        </div>
                                    @endif
                                    <span
                                        class="help-block">{{ trans('cruds.fasedespacho.fields.fecha_despacho_helper') }}</span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control {{ $errors->has('empresa_transporte') ? 'is-invalid' : '' }}"
                                        type="text" name="empresa_transporte" id="empresa_transporte"
                                        value="{{ old('empresa_transporte', $proyecto->fasedespacho->empresa_transporte ?? '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control {{ $errors->has('nombre_conductor') ? 'is-invalid' : '' }}"
                                        type="text" name="nombre_conductor" id="nombre_conductor"
                                        value="{{ old('nombre_conductor', $proyecto->fasedespacho->nombre_conductor ?? '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control {{ $errors->has('celular_conductor') ? 'is-invalid' : '' }}"
                                        type="text" name="celular_conductor" id="celular_conductor"
                                        value="{{ old('celular_conductor', $proyecto->fasedespacho->celular_conductor ?? '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        class="form-control {{ $errors->has('nombre_acompañantes') ? 'is-invalid' : '' }}"
                                        type="text" name="nombre_acompañantes" id="nombre_acompañantes"
                                        value="{{ old('nombre_acompañantes', $proyecto->fasedespacho->nombre_acompañantes ?? '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    @if (!$proyecto->fasedespacho)
                                        <input class="form-check-input carguio" type="checkbox" value="1" id="carguio"
                                            name="carguio">
                                        <input class="form-check-input carguio2" type="hidden" value="0" id="carguio"
                                            name="carguio">
                                ...
                                <div class="form-check">
                                    @if (!$proyecto->fasedespacho)
                                        <input class="form-check-input transporte" type="checkbox" value="1" id="transporte"
                                            name="transporte">
                                        <input class="form-check-input transporte2" type="hidden" value="0" id="transporte"
                                            name="transporte">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Transporte
                                        </label>
                                ...
                                <div class="form-check">
                                    @if (!$proyecto->fasedespacho)
                                        <input class="form-check-input entrega" type="checkbox" value="1" id="entrega"
                                            name="entrega">
                                        <input class="form-check-input entrega2" type="hidden" value="0" id="entrega"
                                            name="entrega">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Entrega
                                        </label>
                            ...
                            <div class="form-group">
                                <label
                                    for="guia_despacho">{{ trans('cruds.fasedespacho.fields.guia_despacho') }}<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos:
                                            .PDF)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('guia_despacho') ? 'is-invalid' : '' }}"
                                    id="guia_despacho-dropzone">
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasedespacho.fields.guia_despacho_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label>{{ trans('cruds.fasedespacho.fields.estado_instalacion') }}</label>
                                <select
                                    class="form-control {{ $errors->has('estado_instalacion') ? 'is-invalid' : '' }}"
                                    name="estado_instalacion" id="estado_instalacion">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasedespacho.fields.estado_instalacion_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <h4>Instalación</h4>
                                <div class="form-check">
                                    @if (!$proyecto->fasedespacho)
                                        <input class="form-check-input distribucion" type="checkbox" value="1"
                                            id="distribucion" name="distribucion">
                                        <input class="form-check-input distribucion2" type="hidden" value="0"
                                            id="distribucion" name="distribucion">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Distribución
                                        </label>
                                    @else
                                        @if($proyecto->fasedespacho->distribucion == 1)
                                            <input class="form-check-input distribucion" type="checkbox" value="1"
                                                id="distribucion" name="distribucion" checked>
                                            <input class="form-check-input distribucion2" type="hidden" value="0"
                                                id="distribucion" name="distribucion">
                                            <label class="form-check-label" for="flexCheckDefault">
                                                Distribución
                                ...
                                <div class="form-check">
                                    @if(!$proyecto->fasedespacho)
                                        <input class="form-check-input armado" type="checkbox" value="1" id="armado"
                                            name="armado">
                                        <input class="form-check-input armado2" type="hidden" value="0" id="armado"
                                            name="armado">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Armado
                                        </label>
                                ...
                                <div class="form-check">
                                    @if (!$proyecto->fasedespacho)
                                        <input class="form-check-input entrega_conforme" type="checkbox" value="1"
                                            id="entrega_conforme" name="entrega_conforme">
                                        <input class="form-check-input entrega_conforme2" type="hidden" value="0"
                                            id="entrega_conforme" name="entrega_conforme">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Entrega conforme
                                        </label>
                                    @else
                                        @if($proyecto->fasedespacho->entrega_conforme == 1)
                                            <input class="form-check-input entrega_conforme" type="checkbox" value="1"
                                                id="entrega_conforme" name="entrega_conforme" checked>
                                            <input class="form-check-input entrega_conforme2" type="hidden" value="0"
                                                id="entrega_conforme" name="entrega_conforme">
                                            <label class="form-check-label" for="flexCheckDefault">
                                                Entrega conforme
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    class="form-control ckeditor {{ $errors->has('comentario') ? 'is-invalid' : '' }}"
                                    name="comentario"
                                    id="comentario">{!! old('comentario', $proyecto->fasedespacho->comentario ?? '') !!}</textarea>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasedespacho.fields.comentario_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasedespacho.fields.recibe_conforme_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label for="galeria_estado_muebles">Galería Mobiliario entregado<br><small
                                        style="color:rgba(255, 0, 0, 0.562);"><strong>(Archivos Permitidos: .JPG
                                            .PNG)</strong></small></label>
                                <div class="needsclick dropzone {{ $errors->has('galeria_estado_muebles') ? 'is-invalid' : '' }}"
                                    id="galeria_estado_muebles-dropzone">
                                </div>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.fasedespacho.fields.galeria_estado_muebles_helper') }}</span>
                            </div>

                            <div class="form-group">
                                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}"
                                    type="hidden" name="estado" id="estado"
                                    value="{{ old('estado', $proyecto->fasedespacho->estado ?? '') }}">
                            </div>
                    ...
                    <div class="carousel-item my-5" id="slide_fase_7">
                        ...
                        <form method="POST" action="{{ route("admin.proyectos.storeFasepostventa") }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id_proyecto_id" id="id_proyecto_id" value="{{$proyecto->id}}">
                            <input type="hidden" name="id_fasepostventa" id="id_fasepostventa"
                                value="{{$proyecto->id_fasepostventa}}">
                            <div class="form-group">
