            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        {{ trans('global.edit') }} {{ trans('cruds.fasefabrica.title_singular') }}
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.fasefabricas.update', [$fasefabrica->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="aprobacion_course" id="aprobacion_course">
                                    ...
                                    @foreach (App\Models\Fasefabrica::APROBACION_COURSE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('aprobacion_course', $fasefabrica->aprobacion_course) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="estado_produccion" id="estado_produccion">
                                    ...
                                    @foreach (App\Models\Fasefabrica::ESTADO_PRODUCCION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('estado_produccion', $fasefabrica->estado_produccion) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date input-custom"
                                    ...
                                    value="{{ old('fecha_entrega', $fasefabrica->fecha_entrega) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_proyecto_id" id="id_proyecto_id">
                                    @foreach ($id_proyectos as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('id_proyecto_id') ? old('id_proyecto_id') : $fasefabrica->id_proyecto->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom"
                                    style="border: none; background-color: #f8f8f8; border-radius: 10px;" type="text"
                                    name="estado" id="estado" value="{{ old('estado', $fasefabrica->estado) }}">
