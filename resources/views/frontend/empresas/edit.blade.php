        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.empresas.update', [$empresa->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="comuna" id="comuna">
                                    ...
                                    @foreach (App\Models\Empresa::COMUNA_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('comuna', $empresa->comuna) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="region" id="region">
                                    ...
                                    @foreach (App\Models\Empresa::REGION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('region', $empresa->region) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nombe_de_fantasia" id="nombe_de_fantasia"
                                    value="{{ old('nombe_de_fantasia', $empresa->nombe_de_fantasia) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rubro" id="rubro"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="estado" id="estado">
                                    ...
                                    @foreach (App\Models\Empresa::ESTADO_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('estado', $empresa->estado) === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
